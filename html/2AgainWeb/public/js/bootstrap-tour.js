  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div> <h3 class="popover-header"></h3> <div class="popover-body"></div> <div class="popover-navigation"> <div class="btn-group"> <a class="btn btn-secondary text-purple small" data-role="end">Skip</a> <a class="btn small" data-role="next">Next</a> </div> </div> </div>',

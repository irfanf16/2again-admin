function Tour(steps, options) {
    ...
    var getPopoverSettings = function(arrows) {
        ...
        template += '<div class="tour-exit"></div>' +
            ...
            '</div>' +
            '<div class="popover-footer btn-group">' +
            '   <a class="btn small tour-prev hidden">' +
            translations.previous +
            '   </a>' +
            '   <a class="btn small btn-transparent text-purple tour-skip">' +
            translations.skip +
            '   </a>' +
            '   <a class="btn small tour-next">' +
            translations.next +
            '   </a>' +
            '</div>' +
            '</div>';

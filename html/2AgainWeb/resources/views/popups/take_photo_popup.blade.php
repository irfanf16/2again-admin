<div class="modal custom edit_photo" id="take_photo_popup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content bg-basecolor2">
            <div class="modal-body text-center">
                <h1 class="">Take your Picture</h1>
                <p class="text-gray mb-4">Follow These Instructions</p>

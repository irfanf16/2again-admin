...
@section('content')
@section('page_title','invitation Detail')

<div id="content">
    <div class="container-fluid">
        <section class="section">
            <form @can('giftInvitation-edit') action="{{ route('admin.invitation.translation.update',$invitation->id) }}" @endcan method="POST"
                ...
                <div class="content-box p-3">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" disabled  value="{{$invitation->name}}"

...
@section('page_title','Invitations')
...
<div id="content">
    <div class="container-fluid">
        ...
        <section class="section">
            ...
            <div class="mb-3">
                <a href="#" data-bs-toggle="modal" data-bs-target="#addInvitation" class="btn"> Add New</a>
            </div>
            @endcan
...
<div class="modal fade" id="addInvitation" tabindex="-1">
            ...
            <form action="{{ route('admin.giftInvitation.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" onKeyPress="if(this.value.length==7) return false;" min="0" name="silver_coin" class="form-control" placeholder="Enter Silver Coins"
                               required>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('admin.giftInvitation.delete') }}">
                @csrf
                <div class="modal-body">
                    <p><span class="text-yellow">Warning!: </span> This Invitation will be permanently removed from the
                        system</p>
                </div>
...
<script type="text/javascript">
    $(function () {
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.invitations.list') }}",
            columns: [

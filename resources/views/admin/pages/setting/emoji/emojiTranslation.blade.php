...
@section('content')
@section('page_title','Daily Mood Detail')

<div id="content">
    <div class="container-fluid">
        <section class="section">
            <form @can('emoji-edit') action="{{ route('admin.emoji.update.translation',$emoji->id) }}" @endcan method="POST"
                ...
                <div class="content-box p-3">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>English</label>
                            <input type="text" disabled  value="{{$emoji->name}}"

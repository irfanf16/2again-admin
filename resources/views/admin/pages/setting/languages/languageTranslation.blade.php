...
@section('content')
@section('page_title','Language Detail')

<div id="content">
    <div class="container-fluid">
        <section class="section">
            <form @can('language-edit') action="{{ route('admin.languages.translation.update',$language->id) }}" @endcan method="POST"
                ...
                <div class="content-box p-3">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>English</label>
                            <input type="text" disabled  value="{{$language->name}}"

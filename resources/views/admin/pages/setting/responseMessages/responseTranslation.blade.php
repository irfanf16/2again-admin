...
@section('content')
@section('page_title','Response Messages Detail')

<div id="content">
    <div class="container-fluid">
        <section class="section">
            <form @can('language-edit') action="{{ route('admin.response.messages.translation.update',$response->id) }}" @endcan method="POST"
                ...
                <div class="content-box p-3">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>English</label>
                            <input type="text" disabled  value="{{$response->key_translation}}"

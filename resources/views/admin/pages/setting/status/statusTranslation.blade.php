...
@section('content')
@section('page_title','Status Detail')

<div id="content">
    <div class="container-fluid">
        <section class="section">
            <form @can('status-edit') action="{{ route('admin.status.translations.save',$status->id) }}" @endcan method="POST"
                ...
                <div class="content-box p-3">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>English</label>
                            <input type="text" disabled  value="{{$status->name}}"
